//Set defaults
(function( $ ) {
  console.log('SmarterGiving initialized');
  $(function(){
      ...
      $('.js-daf-submit').click(function (e) {
        ...
        var txtSet = function () {
          if (sessionStorage.getItem('coinvest', true))
            return encodeURIComponent('The Kyn Project - Spark CoINVEST');
          else
            return encodeURIComponent('We found you via The Kyn Project - kyn.me');
        };
        var txt = txtSet();
        // --- Google Analytics ---
